  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill={isInWishlist ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="md:w-[18px] md:h-[18px]">
    ...
    >
      ...
      <div className="flex min-h-screen relative">
        ...
        {showMobileFilters && (
          ...
          >
            <aside
              className="absolute left-0 top-0 bottom-0 w-72 h-screen overflow-y-auto p-6 pt-20 pb-24 flex flex-col gap-4 animate-slideIn"
            ...
            >
              ...
              <div className="flex flex-col gap-8 overflow-y-auto custom-scrollbar pr-2 flex-1 pb-4">
                {/* Categories */}
                <section>
                  <div
              ...
              <button
                className="w-full py-3 font-bold rounded-xl text-sm transition-all duration-200 shadow-sm mb-20"
                style={{
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8 pt-20 md:pt-22">
          ...
          {/* Books Grid */}
           <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4 max-w-9xl mx-auto">
          ...
          <div className="mt-12 md:mt-16 flex justify-center">
            ...
            >
              <span className="hidden sm:inline">View More Archive Items</span>
